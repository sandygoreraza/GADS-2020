...
public class LoadDataTopLearnersTask extends AsyncTask<String,String,String> {

    private NetworkResponseListener networkResponseListener;

    public LoadDataTopLearnersTask(NetworkResponseListener networkResponseListener){
    ...
    protected String doInBackground(String... strings) {
        ...
        Request request=new  Request.Builder().url("https://gadsapi.herokuapp.com/api/hours").build();
